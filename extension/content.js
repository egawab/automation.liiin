...

{
  ...
  async function extractPipeline(keyword, settings, comments, dashboardUrl, userId) {
    ...
    const STALL_LIMIT = 8;
    const ABSOLUTE_SAFETY_LIMIT = 400; // Physical safety stop, but mostly relies on exhaustion
    const SCANNED_RESULTS_LIMIT = 150; // Strict limit: 150 items scanned per keyword (Time Optimized)
    let stallCount = 0;
    let step = 0;
